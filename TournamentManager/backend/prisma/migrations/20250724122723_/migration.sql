/*
  ...
  - Added the required column `teamName` to the `Standing` table without a default value. This is not possible if the table is not empty.
...
INSERT INTO "new_Standing" ("draws", "goalsAgainst", "goalsFor", "groupId", "id", "losses", "points", "position", "teamId", "tournamentId", "wins") SELECT "draws", "goalsAgainst", "goalsFor", "groupId", "id", "losses", "points", "position", "teamId", "tournamentId", "wins" FROM "Standing";
DROP TABLE "Standing";
